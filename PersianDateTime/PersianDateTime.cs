        ...
        public string ToString([StringSyntax("DateTimeFormat")] string? format)
        {
            ...
            if (format.Length > 1)
            {
                s.Replace("ss", Second.ToString("D2"))
                  ...
                  .Replace("HH", Hour.ToString("D2"))
                  .Replace("H", Hour.ToString())
                  .Replace("dddd", DayOfWeek.ToString())
            ...
            else
            {
                s.Replace("d", $"{Year}/{Month:D2}/{Day:D2}")
                  .Replace("D", $"{DayOfWeek}, {Day:D2} {MonthOfYear}, {Year}")
                  .Replace("f", $"{DayOfWeek}, {Day:D2} {MonthOfYear}, {Year} {Hour:D2}:{Minute:D2}")
                  .Replace("F", $"{DayOfWeek}, {Day:D2} {MonthOfYear}, {Year} {Hour:D2}:{Minute:D2}:{Second:D2}")
